...
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('1','hero_title','About Eleven Roofing Dasma','Your trusted roofing partner in Dasmarinas, Cavite',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('2','hero_subtitle','Professional Roofing Services','Twelve years of excellence, thousands of roofs built, and a commitment to quality.',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('3','story_body','Our Story','Eleven Roofing Dasma was founded in 2013 by seasoned professionals who believed every property deserves a roof that stands the test of time. What started as a small crew has grown into one of the most trusted roofing companies in Cavite, with over 500 projects completed.',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('4','mission','Our Mission','To deliver world-class roofing solutions with integrity, craftsmanship, and care.',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('5','vision','Our Vision','To be the most trusted roofing company in Cavite, known for excellence and lasting client partnerships.',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('6','years','Years in Business','12',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('7','projects','Projects Completed','500+',NULL,'2026-05-03 23:42:17');
INSERT INTO `about_content` (`id`,`section_key`,`title`,`content`,`updated_by`,`updated_at`) VALUES ('8','team_size','Team Size','50+',NULL,'2026-05-03 23:42:17');
...
INSERT INTO `products` (`product_id`,`category_id`,`product_name`,`description`,`price`,`stock_quantity`,`min_stock`,`image_path`,`icon_emoji`,`is_active`,`created_at`,`updated_at`) VALUES ('1','1','Corrugated G.I. Sheet 0.5mm','Standard corrugated galvanized iron sheets.','280.00','240','100',NULL,'🟫','1','2026-05-03 23:42:16','2026-05-03 23:42:16');
...
INSERT INTO `products` (`product_id`,`category_id`,`product_name`,`description`,`price`,`stock_quantity`,`min_stock`,`image_path`,`icon_emoji`,`is_active`,`created_at`,`updated_at`) VALUES ('11','5','Butyl Tape 2x10m','Self-adhesive butyl rubber tape.','280.00','150','50',NULL,'📦','1','2026-05-03 23:42:16','2026-05-03 23:42:16');
...
INSERT INTO `system_settings` (`setting_key`,`setting_value`,`locked_by`,`updated_at`) VALUES ('lock_chatbot','0','7','2026-05-04 06:57:50');
...
INSERT INTO `system_settings` (`setting_key`,`setting_value`,`locked_by`,`updated_at`) VALUES ('lock_services','1','7','2026-05-04 06:57:50');
...
INSERT INTO `users` (`user_id`,`full_name`,`email`,`password`,`contact_number`,`address`,`role_id`,`status`,`created_at`,`updated_at`) VALUES ('7','test2 test2','Customer@gmai.com','$2y$10$MXJT7UrbgASUNE6H0DCU9.IrLC6sxuIHCfGSdFFPJgWPRPUM./9ba','36623657392797','bab','2','active','2026-05-04 06:17:14','2026-05-04 06:43:29');
